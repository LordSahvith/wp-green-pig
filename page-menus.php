  ...
  <section class="menu-welcome-section">
    ...
    <div class="container">
      ...
      <div class="fade-left">
        ...
        <p>The place you come to when hungry and lost downtown. Or maybe thirsty...either way we got you&nbsp;covered.</p>
      ...
      <div class="fade-left">
        ...
        <h3 class="intro-title">Need a Visual?</h3>

      </div>

      <div class="fade-right">

        <p>Here are some Pig Favorites...</p>
