...
// monday gallery
$mon_instagram       = get_field('mon_instagram');
...
// tuesday gallery
$tue_instagram       = get_field('tue_instagram');
...
// wednesday gallery
$wed_instagram       = get_field('wed_instagram');
...
// thursday gallery
$thur_instagram       = get_field('thur_instagram');
...
// friday gallery
$fri_instagram       = get_field('fri_instagram');
...
// saturday gallery
$sat_instagram       = get_field('sat_instagram');
...
// sunday gallery
$sun_instagram       = get_field('sun_instagram');
    ...
    <div class="overlay-content">
      ...
      <div class="container">
        <div class="col col-xs-6 col-md-4">
          <button id="event-mon-btn" class="event-menu-btn" onclick="closeNav()">Mon <span id="mon-date" class="date"></span></button>
        </div>

        <div class="col col-xs-6 col-md-4">
          <button id="event-tue-btn" class="event-menu-btn" onclick="closeNav()">Tue <span id="tue-date" class="date"></span></button>
        </div>

        <div class="col col-xs-6 col-md-4">
          <button id="event-wed-btn" class="event-menu-btn" onclick="closeNav()">Wed <span id="wed-date" class="date"></span></button>
        </div>

        <div class="col col-xs-6 col-md-4">
          <button id="event-thu-btn" class="event-menu-btn" onclick="closeNav()">Thu <span id="thu-date" class="date"></span></button>
        </div>

        <div class="col col-xs-6 col-md-4">
          <button id="event-fri-btn" class="event-menu-btn" onclick="closeNav()">Fri <span id="fri-date" class="date"></span></button>
        </div>

        <div class="col col-xs-6 col-md-4">
          <button id="event-sat-btn" class="event-menu-btn" onclick="closeNav()">Sat <span id="sat-date" class="date"></span></button>
        </div>
        <div class="col">
          <button id="event-sun-btn" class="event-menu-btn" onclick="closeNav()">Sun <span id="sun-date" class="date"></span></button>
        </div>
      </div>
    </div>
  </div>
