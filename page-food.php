...
<section class="hero hero-food" style="background: url(<?php echo $hero_image['url']; ?>) center center no-repeat;">
  ...
  <nav id="scrolling-food-menu" class="scrolling-menu hide slide">
    ...
    <ul>
      <li><button id="starters-btn" class="scrolling-btn">Starters</button></li>
      <li><button id="specialties-btn" class="scrolling-btn">Specialties</button></li>
      <li><button id="sandwiches-btn" class="scrolling-btn">Sandwiches</button></li>
      <li><button id="burgers-btn" class="scrolling-btn">Burgers</button></li>
      <li><button id="greens-btn" class="scrolling-btn">Bowls/<br>Greens</button></li>
      <li><button id="specials-btn" class="scrolling-btn">Daily<br>Specials</button></li>
    </ul>
  </nav>
  ...
  <div id="menu-breakfast">
    ...
    <section class="food-breakfast-section">
      <div class="container">
        ...
        <div class="fade-in">
          <p>All you can eat brunch buffet only $12. With a variety of breakfast items you won't be disappointed. Everything is made fresh each Sunday morning including omlets which are cooked to order. We also have maple bacon, french toast, fresh fruit and much more,
            including an assortment of vegan friendly options. Don't miss out this Sunday and come enjoy your last day before back
            to the&nbsp;grind.</p>
        </div>
      </div> <!-- container -->
    </section> <!-- breakfast -->
